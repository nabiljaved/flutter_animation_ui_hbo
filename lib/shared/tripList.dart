...
class _TripListState extends State<TripList> {
  ...
  void _addTrips() {
    // get data from db
    List<Trip> _trips = [
      Trip(title: 'Raised by Wolves', price: '350', nights: '3', img: 'by_wolves.jpg'),
      Trip(title: 'Zack snyder\'s', price: '400', nights: '5', img: 'zack.jpg'),
      Trip(title: 'Love Life', price: '750', nights: '6', img: 'love.jpg'),
      Trip(title: 'Doom Patrol', price: '600', nights: '8', img: 'doom.jpg'),
      Trip(title: 'Flight Attendent', price: '600', nights: '5', img: 'flight.jpg'),
    ];
